...
{
    return initialOptions.withOptionsFrom (input_gain_relay_).withOptionsFrom (filter_size_relay_);
}
...
ParameterAttachments::ParameterAttachments (ParameterRelay & parameter_relay,
    ...
    , filter_size_attachment_ (*parameter_tree.getParameter (ParameterTree::kFilterSizeParameterId),
                               parameter_relay.filter_size_relay_)
